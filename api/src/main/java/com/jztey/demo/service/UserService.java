...
public interface UserService {
	...
	@RequestMapping(value = "/pb/city", method = RequestMethod.GET)
	@ApiOperation(value = "取出省市区等,一个递归的套路", response = RestfulResultUser.class)
	...
	//// 测试统一的异常处理的方法//////
	@RequestMapping(value = "/pb/exception", method = RequestMethod.POST)
	@ApiOperation(value = "统一的异常处理的方法的例子", response = RestfulResultUser.class)
	RestfulResult<User> getException(@Valid @RequestParam("id") int id);
